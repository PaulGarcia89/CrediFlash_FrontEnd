...
function CuotasModule() {
    ...
    const [status, setStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$crediflash$2d$vuexy$2d$next$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('ACTIVO');
    ...
    const confirmarPago = async ()=>{
        ...
        try {
            ...
            setSuccess(`Pago semanal registrado para ${selectedPrestamo.nombre_completo || selectedPrestamo.id}.`);
            closePagoDialog();
            await loadPrestamos();
        } catch (err) {
            ...
            if (shouldGenerateCuotas) {
                try {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$crediflash$2d$vuexy$2d$next$2f$src$2f$api$2f$cuotas$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registrarPagoSemanal"])(selectedPrestamo.id, parsedMonto);
                    setSuccess(`Cuotas generadas y pago registrado para ${selectedPrestamo.nombre_completo || selectedPrestamo.id}.`);
                    closePagoDialog();
                    await loadPrestamos();
                    return;
                } catch (retryError) {
    ...
    const openHistorial = async (row)=>{
        ...
        if (!clienteId) {
            setError('No se encontró cliente_id en este préstamo para consultar historial.');
            return;
        }
        setHistorialCliente({
            id: clienteId,
...
//# sourceMappingURL=crediflash-vuexy-next_src_f244e9b9._.js.map